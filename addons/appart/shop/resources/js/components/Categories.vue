<template>
    <div>
        <data-list ref="list"
                   :visibleColumns="columns" :columns="columns" :rows="rows" sortColumn="path" sortDirection="asc">
            <div class="card p-0 relative" slot-scope="{ filteredRows: rows }">
                <data-list-bulk-actions url="api/actions/staged"
                                        @started="beginAction" @completed="finishAction"/>

                <data-list-table
                    :rows="rows" allow-bulk-actions="true">
